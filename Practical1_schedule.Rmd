...
* Navigate to your "NES2504" folder, right-click in a blank area inside the NES2504 folder and select "Paste"
* **NOTE** You may prefer to have a subfolder called `Data` inside `NES2504`. If so, remember to add a `Data\` prefix to the file names in your `read.csv` functions below.
